...
{
    public class CreditacaoDomain : ICreditacaoDomain
    {
        private readonly ISagaService _creditacoesService;

        public CreditacaoDomain(ISagaService creditacoesService)
        {
            _creditacoesService = creditacoesService;
        }

        public string CreditacaoWithNewCardCreation(string cardId, string courseName, string studentName, string courseInstitute, DateTime dueTime, bool IsCetOrOtherCondition, int boardId)
        {
