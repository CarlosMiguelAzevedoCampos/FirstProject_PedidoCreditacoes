...
namespace CMA.ISMAI.UnitTests.Trello.Domain
{
    public class DomainAddCardAndProcess_TrelloServiceTest
    {
        ...
        public void TrelloService_AddCardAndProcess_ShouldFail_BecauseOfNullOrEmptyParameters(string name, string description, int boardId, string instituteName, string courseName, string studentName, bool isCet)
        {
        ...
        public void TrelloService_AddCardAndProcess_ShouldFail_BecauseOfNullUrlAttachments(string name, string description, int boardId, string instituteName, string courseName, string studentName, bool isCet)
        {
            var logMock = new Mock<ILog>();
            var trelloMock = new Mock<ITrello>();
            var cardnotificationMock = new Mock<ICardEventHandler>();
        ...
        public void TrelloService_AddCardAndProcess_ShouldFail_TrelloProcessFailed(string name, string description, int boardId, string instituteName, string courseName, string studentName, bool isCet)
        {
            var logMock = new Mock<ILog>();
            var trelloMock = new Mock<ITrello>();
            var cardnotificationMock = new Mock<ICardEventHandler>();
        ...
        [InlineData("ISMAI - Informatica - Carlos Campos", "Informática", 2, "ISMAI", "Informática", "Carlos Campos", false)]
        [InlineData("ISMAI - Informatica - Carlos Campos", "Informática", 3, "ISMAI", "Informática", "Carlos Campos", false)]
        public void TrelloService_AddCardAndProcess_ShouldFail_EngineProcessFailed(string name, string description, int boardId, string instituteName, string courseName, string studentName, bool isCet)
        {
            var logMock = new Mock<ILog>();
            var trelloMock = new Mock<ITrello>();
            var cardnotificationMock = new Mock<ICardEventHandler>();
        ...
        public void TrelloService_AddCardAndProcess_ShouldReturn_AddCardCompletedEvent(string name, string description, int boardId, string instituteName, string courseName, string studentName, bool isCet)
        {
            var logMock = new Mock<ILog>();
            var trelloMock = new Mock<ITrello>();
            var cardnotificationMock = new Mock<ICardEventHandler>();
